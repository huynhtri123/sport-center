                ...
                <tbody>
                    {courses.map((course, index) => (
                        <tr key={course.id}>
                            ...
                            <td>
                                <button className={`btn ${styles.editButton}`} onClick={() => handleEditCourse(course)}>Edit</button>
                                <button className={`btn ${styles.deleteButton}`} onClick={() => handleDeleteCourse(course.id)}>Delete</button>
                            </td>
                        </tr>
                    ))}
                </tbody>
