            ...
            <form onSubmit={handleSubmit} className={clsx(styles.signupBox, 'flex-column')}>
                ...
                <div className={`input-box d-flex flex-column mt-4 ${styles.inputGroup}`}>
                    <div className={styles.inputBox}>
                        <label htmlFor="fullname" className='font-cera-round-pro-bold ms-2'>Full Name</label>
                    ...
                    <div className={styles.inputBox}>
                        ...
                        <Input className='mb-3' type={'password'} placeHolder={'Enter strong password...'} id="password" />
                    </div>

                    <div className={styles.inputBox}>
                        <label htmlFor="confirmPassword" className='font-cera-round-pro-bold ms-2'>Confirm Password</label>
                        <Input className='mb-3' type={'password'} placeHolder={'Confirm your password...'} id="confirmPassword" />
                    </div>
                </div>
