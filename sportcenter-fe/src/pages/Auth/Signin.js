...
function Signin() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const { email, tokenType, token, refreshToken } =
                siginResponse.Data;
    ...
    return (
        <div className={clsx(styles.loginContainer)}>
            <form
                ...
                className={clsx(styles.signinBox, "flex-column")}
            >
                <div className="font-size-24px mb-5 d-flex flex-column">
                    ...
                    <span className="font-cera-round-pro-black font-size-32px">
                        Sign In to Your Account
                    </span>
                </div>

                <div
                    className={`input-box d-flex flex-column mt-4 ${styles.inputGroup}`}
                >
                    <div className={styles.inputBox}>
                        <label
                            htmlFor="email"
                            className="font-cera-round-pro-bold ms-2"
                        >
                            Email Address
                        </label>
                        <Input
                ...
                <div className="font-cera-round-pro-regular mt-2">
                    New here?
                    <Link className="text-underline ms-2">
