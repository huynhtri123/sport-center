...
public class JwtAuthenticationEntryPoint implements AuthenticationEntryPoint {
    ...
    public void commence(HttpServletRequest request, HttpServletResponse response,
        ...
        if (authException instanceof BadCredentialsException) {
            ...
            message = "Login information is incorrect. Please check your email and password again.";
            errorCode = ErrorCode.INVALID_CREDENTIALS.name();
        } else {
            // hết hạn token
            message = "Credentials are invalid or have expired. Please log in and try again.";
