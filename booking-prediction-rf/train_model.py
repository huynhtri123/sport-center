...
def train_and_save_model():
    ...
    if os.path.exists(model_path):
        predictor = BookingPredictor.load_model(model_path)
        print("[INFO] Đã tải model từ file, bỏ qua bước huấn luyện.")
    else:
        print("[INFO] Không tìm thấy model, tiến hành huấn luyện.")
        ...
        print(f"[INFO] Model trained. Accuracy: {predictor.model.score(X_test, y_test):.4f}")
